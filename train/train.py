...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_config', default="configs/v1-train-chinese-lora.yaml", type=str, help='model config path')
    parser.add_argument('--pretrained_model_path', default="", type=str, help='pretrained model directory')
    parser.add_argument('--pretrained_model_file', default="wukong-huahua-ms.ckpt", type=str, help='pretrained model file name')
    ...
    parser.add_argument("--save_checkpoint_steps", default=500, type=int, help="save checkpoint steps")
    ...
    parser.add_argument('--image_size', default=1024, type=int, help='images size')
